...
static char * read_empty_line(FILE * file, char * buff, size_t buff_size) {
  char * ret;
...
static char * read_non_empty_line(FILE * file, char * buff, size_t buff_size) {
  char * ret;
  ret = read_line(file, buff, buff_size);
...
static char * find_block_start(FILE * file, char * buff, size_t buff_size) {
  char * line;
 ...
 */
static struct tree_node * parse_node(FILE * file, struct tree_node * node) {
